...
import { ChevronsLeft, ChevronsRight, Car, RotateCw, Menu } from "lucide-react";
...
<header className="sticky top-0 z-50 bg-white w-full border-b border-black/10 px-6 py-6 flex items-center justify-between">
  ...
  {/* Desktop Nav */}
  <nav className="hidden lg:flex gap-10 text-base font-bold text-gray-950 justify-center flex-1 [font-family:'Libre_Baskerville',serif]">
...
{isMobileNavOpen && (
  <div className="lg:hidden fixed top-[72px] inset-x-0 z-40 bg-white border-b border-black/10 px-6 py-4 text-center space-y-4 shadow-md">
    <a href="#overview" onClick={() => setIsMobileNavOpen(false)} className="block text-lg font-semibold text-gray-800 hover:underline">
      Overview
    </a>
    <a href="#vans" onClick={() => setIsMobileNavOpen(false)} className="block text-lg font-semibold text-gray-800 hover:underline">
      Vans for Sale
    </a>
    <a href="#layout" onClick={() => setIsMobileNavOpen(false)} className="block text-lg font-semibold text-gray-800 hover:underline">
      Layout
    </a>
    <a href="#builder" onClick={() => setIsMobileNavOpen(false)} className="block text-lg font-semibold text-gray-800 hover:underline">
      3D Van Builder
    </a>
  </div>
)}
      ...
      >                                      
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-col items-center gap-3">
           ...
           <button className="flex items-center gap-2 text-neutral-950 font-bold text-lg hover:text-black">
            More Layouts
